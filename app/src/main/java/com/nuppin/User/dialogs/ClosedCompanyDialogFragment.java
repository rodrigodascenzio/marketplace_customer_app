...
public class ClosedCompanyDialogFragment extends DialogFragment {
    private ClosedCompanyDialogListener listener;

    String stringMessage, stringPositive, stringNegative;

    public static ClosedCompanyDialogFragment newInstance(String stringMessage, String btnPositive, String btnNegative) {
        ClosedCompanyDialogFragment fragment = new ClosedCompanyDialogFragment();
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        try {
            listener = (ClosedCompanyDialogListener) getParentFragment();
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        View layout = inflater.inflate(R.layout.fr_dialog_company_closed, null);
        ...
        btnPositive.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                listener.onDialogOKClick(btnPositive, ClosedCompanyDialogFragment.this);
            }
        });
        btnNegative.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                listener.onDialogOKClick(btnNegative, ClosedCompanyDialogFragment.this);
            }
        });
    ...
    public interface ClosedCompanyDialogListener {
        void onDialogOKClick(View view, ClosedCompanyDialogFragment infoDialogFragment);
